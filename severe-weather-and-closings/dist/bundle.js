...
var _bcStatusIcon = __webpack_require__(332);

var _closingsController = __webpack_require__(331);

var _dataService = __webpack_require__(328);

var _dataMockProvider = __webpack_require__(329);

var closingsDataService = new _dataService.dataService(_dataMockProvider.dataProvider);
angular.module('severeWeatherAndClosings', []).directive('bcStatusIcon', _bcStatusIcon.bcStatusIcon).factory('severeWeatherAndClosings.dataService', function () {
  return closingsDataService;
}).controller('severeWeatherAndClosings.closingsController', ['$sce', 'severeWeatherAndClosings.dataService', _closingsController.closingsController]);
...
function () {
  ...
  _createClass(dataService, [{
    key: "getClosings",
    value: function getClosings() {
      return this.dataProvider.getClosings();
    }
  }, {
    key: "getGeneralCountyInformation",
    value: function getGeneralCountyInformation() {
...
var Closing = _interopRequireWildcard(__webpack_require__(330));
...
function () {
  ...
  _createClass(dataProvider, [{
    key: "getClosings",
    value: function getClosings() {
      return data.map(function (closing) {
        return new Closing(closing.status, closing.agency, closing.info);
      });
    }
  }, {
    key: "getGeneralCountyInformation",
...
exports.Closing = void 0;

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

/* eslint-disable import/prefer-default-export */
var Closing = function Closing(status, agency, info) {
  _classCallCheck(this, Closing);
...
exports.closingsController = void 0;

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

/* eslint-disable import/prefer-default-export */
var closingsController = function closingsController($sce, dataService) {
  _classCallCheck(this, closingsController);

  this.dataProvider = dataService;
  this.isLoading = true;
  var data = dataService.getClosings();
...
exports.closingsController = closingsController;
;
...
exports.bcStatusIcon = void 0;

/* eslint-disable import/prefer-default-export */
var getIconType = function getIconType(status) {
  var types = {
    canceled: 'fa-times',
    cancelled: 'fa-times',
    closed: 'fa-times',
...
var bcStatusIcon = function bcStatusIcon() {
  return {
    restrict: 'E',
...
exports.bcStatusIcon = bcStatusIcon;
